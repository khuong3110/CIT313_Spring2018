...
<h1><?php echo $title;?></h1>
    ...
    <h3><a href="<?php echo BASE_URL?>blog/post/<?php echo $p['pID'];?>" title="<?php echo $p['title'];?>"><?php echo $p['title'];?></a></h3>
        <h6 style="color:#bdbdbd;"><?php $d = new DateTime( $p['date']); echo $d->format("l, F d, Y h:i:s ")?> - Author: <?php echo $p['first_name'];?> <?php echo $p['last_name'];?> - Category: <a href="<?php echo BASE_URL;?>blog/category/<?php echo $p['categoryID'];?>"><?php echo $p['name'];?></a></h6>
